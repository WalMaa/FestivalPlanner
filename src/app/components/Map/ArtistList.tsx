                ...
                return (
                    <li key={artist.id} className={`flex h-20 shadow-sm shadow-white p-2 bg-white duration-700 transition mr-1 my-1  justify-between rounded-lg 
                        ...
                        <div className="flex justify-end">
                            {preview.playbackUrl != null &&
                                <button className="mr-1" onClick={() => togglePlay(artist.id)}>
                                    {artist.id === isPlaying ?
                                        ...
                                        :
                                        // Play Icon
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor" className="w-11 h-11 hover:scale-110 transition-transform active:scale-90">
                            ...
                            {/* Spotify Logo */}
                            <a href={artist.spotifyId} target="_blank" rel="noopener noreferrer" className="self-center hover:scale-110 transition-transform active:scale-90">
