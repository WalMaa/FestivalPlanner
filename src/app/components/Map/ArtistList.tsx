...
const ArtistList = ({ artistIds }: { artistIds: string[] }) => {
    ...
    return (
        <div className="flex flex-shrink flex-col overflow-auto px-2 mx-1 sm:mx-2 scroll-smooth scrollbar-thin scrollbar-thumb-zinc-200 scrollbar-track-gray h-80">
